                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-danger" id="nameError" data-ajax-feedback="username"></div>
                        </div>

                        <div class="mb-3">
                            <label for="phone" class="form-label">Phone</label>
                            <input type="text" class="form-control input-mask @error('phone') is-invalid @enderror"
                                   value="{{ Auth::user()->phone }}" id="phone" name="phone" autofocus
                                   data-inputmask="'mask': '999-99-999-99-99'"
                                   placeholder="Enter phone">
                            <div class="text-danger" id="nameError" data-ajax-feedback="phone"></div>
                        </div>
                        ...
                        <div class="mt-3 d-grid">
                            <button class="btn btn-primary waves-effect waves-light UpdateProfile"
                                    data-id="{{ Auth::user()->id }}" type="submit">Update
                            </button>
                        </div>
                    </form>
                </div>
