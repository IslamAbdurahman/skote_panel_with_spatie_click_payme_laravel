        ...
        <div class="dropdown d-inline-block">
            ...
            <button type="button" class="btn header-item waves-effect"
                ...
                @switch(Session::get('lang'))
                    ...
                    @break
                    @case('uz')
                        <img src="{{ URL::asset('/assets/images/flags/uzb.jpg')}}" alt="Header Language" height="16">
                        @break
                    @case('krill')
                        <img src="{{ URL::asset('/assets/images/flags/uzb.jpg')}}" alt="Header Language" height="16">
                        @break
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a href="{{ url('index/uz') }}" class="dropdown-item notify-item language" data-lang="ru">
                    <img src="{{ URL::asset ('/assets/images/flags/uzb.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Uzbek</span>
                </a>

                <!-- item-->
                <a href="{{ url('index/krill') }}" class="dropdown-item notify-item language" data-lang="ru">
                    <img src="{{ URL::asset ('/assets/images/flags/uzb.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Krill</span>
                </a>
